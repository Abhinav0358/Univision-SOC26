...
cropped_img = img[200:400, 250:550]  # Grabbing roughly the grill/plate area
...
gray_img = cv2.cvtColor(img, cv2.COLOR_BGR2YCrCb)
...
print("\n--- Pixel Data Look ---")
print(f"Raw Pixel (0,0) (BGR): {resized_img[0, 0]}")
print(f"Normalized Pixel:      {normalized_img[0, 0]}")
